...
# path='/home/afsari/gpc_SNEC/s18.8_1644_K_4.00E+17_mni0.1/output/rho_initial.dat'
# path1='/home/afsari/gpc_SNEC/s18.8_1644_K_4.00E+17_mni0.1/output/mass_initial.dat'
# data=np.genfromtxt(path,delimiter='  ')
# data1=np.genfromtxt(path1,delimiter='  ')
# plt.plot(data1[:1301,1]/1.99e33,np.log10(data[:1301,1]))
# plt.show()
