...
def dophot(filename,verbosity=0, output=0):
    ...
    diffext='.nh.REF-SUB_v4.fits'
    outext = '.nh.psfphot9_temp.cat'
    os.chdir(files_path)
    info = filename.split('.')
    band=info[2]
    files_sub=filename.replace('.nh.REF-SUB_v4conv.fits',diffext)
    print files_sub
    file_phot='temp.cat'
    #file_phot='N2188-1.Q2.V.170430_0926.A.056477.061035N3413.0060_tan.nh.phot.apass.csv'
    file_output=filename.replace('.nh.REF-SUB_v4conv.fits',outext)
    if output==1:
    ...
    if verbosity==1:
        run_command = 'python ~/SNAP3/MagCalc.py -c  aavso -o  N2188-1.Q2.SN -b \'' + band + '\' -p 92.654754:-34.14111 -psf 2 -fwhm 5 -v -n 3.0  -y 2016 -s 14.0 -r 1000 -f 19 --fit_sky ' + filename + ' -d ' + files_sub + ' ' + file_phot + file_output
    elif verbosity==2:
        run_command = 'python ~/SNAP3/MagCalc.py -c  aavso -o  N2188-1.Q2.SN -b \'' + band + '\' -p 92.654754:-34.14111 -psf 2 -fwhm 5 -vv -n 3.0  -y 2016 -s 14.0 -r 1000 -f 19 --fit_sky ' + filename + ' -d ' + files_sub + ' ' + file_phot + file_output
    elif verbosity==3:
        run_command = 'python ~/SNAP3/MagCalc.py -c  aavso -o  N2188-1.Q2.SN -b \'' + band + '\' -p 92.654754:-34.14111 -psf 2 -fwhm 5 -vvv -n 3.0  -y 2016 -s 14.0 -r 1000 -f 19 --fit_sky ' + filename + ' -d ' + files_sub + ' ' + file_phot + file_output
    elif verbosity==4:
        run_command = 'python ~/SNAP3/MagCalc.py -c  aavso -o  N2188-1.Q2.SN -b \'' + band + '\' -p 92.654754:-34.14111 -psf 2 -fwhm 5 -vvvv -n 3.0  -y 2016 -s 14.0 -r 1000 -f 19 --fit_sky ' + filename + ' -d ' + files_sub + ' ' + file_phot + file_output
    else:
        run_command = 'python ~/SNAP3/MagCalc.py -c  aavso -o  N2188-1.Q2.SN -b \'' + band + '\' -p 92.654754:-34.14111 -psf 2 -fwhm 5 -n 3.0  -y 2016 -s 14.0 -r 1000 -f 19 --fit_sky ' + filename + ' -d ' + files_sub + ' ' + file_phot + file_output
