...
f_B = open('phot_csv/N300-B_v1.csv', 'w')
f_I = open('phot_csv/N300-I_v1.csv', 'w')
f_V = open('phot_csv/N300-V_v1.csv', 'w')
...
files_path='/home/afsari/N300/'
outext='.nh.psf_magcalc_v1.cat'
os.chdir(files_path)
filename='N300-1.Q2.*.*.*.*.*.0060'+outext
bands={'B':0,'I':1,'V':2}
