...
for i,dat in enumerate(binnedB[:,0]):
    ...
    mag = np.concatenate((mag, add), axis=0)
mag=mag[mag[:,0]>357]
np.save("phot_csv/compiledSN_"+"B"+"_"+"KSPN2188_v1"+".npy", mag)
np.savetxt("phot_csv/compiledSN_"+"B"+"_"+"KSPN2188_v1"+".csv", mag)
...
for i,dat in enumerate(binnedV[:,0]):
    ...
    mag = np.concatenate((mag, add), axis=0)
mag=mag[mag[:,0]>357]
np.save("phot_csv/compiledSN_"+"V"+"_"+"KSPN2188_v1"+".npy", mag)
np.savetxt("phot_csv/compiledSN_"+"V"+"_"+"KSPN2188_v1"+".csv", mag)
...
for i,dat in enumerate(binnedI[:,0]):
    ...
    mag = np.concatenate((mag, add), axis=0)
mag=mag[mag[:,0]>357]
np.save("phot_csv/compiledSN_"+"I"+"_"+"KSPN2188_v1"+".npy", mag)
np.savetxt("phot_csv/compiledSN_"+"I"+"_"+"KSPN2188_v1"+".csv", mag)
