...
data_B = np.genfromtxt(current_path+ '/phot_csv/KSP-N2997-1-2018oh.B.lc.CN_180627.txt', delimiter=',')
data_V = np.genfromtxt(current_path+'/phot_csv/KSP-N2997-1-2018oh.V.lc.CN_180627.txt', delimiter=',')
data_I = np.genfromtxt(current_path+'/phot_csv/KSP-N2997-1-2018oh.I.lc.CN_180627.txt', delimiter=',')

print data_B[90,:]
ax1=plt.subplot(111)
ax1.errorbar(data_B[:,1][data_B[:,7]<data_B[:,9]]-64, data_B[:,7][data_B[:,7]<data_B[:,9]]+1, yerr= data_B[:, 8][data_B[:,7]<data_B[:,9]], color='blue', label='B+1',fmt='o',markersize=6,markeredgecolor='black',
              markeredgewidth=1.2)
ax1.errorbar(data_V[:,1][data_V[:,7]<data_V[:,9]]-64, data_V[:,7][data_V[:,7]<data_V[:,9]], yerr= data_V[:, 8][data_V[:,7]<data_V[:,9]], color='green', label='V',fmt='o',markersize=6,markeredgecolor='black',
              markeredgewidth=1.2)
ax1.errorbar(data_I[:,1][data_I[:,7]<data_I[:,9]]-64, data_I[:,7][data_I[:,7]<data_I[:,9]]-2, yerr= data_I[:, 8][data_I[:,7]<data_I[:,9]], color='red', label='I-2',fmt='o',markersize=6,markeredgecolor='black',
              markeredgewidth=1.2)
